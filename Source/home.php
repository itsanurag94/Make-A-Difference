...
<div class="container-fluid">
  <div class="row content">
    ...
    <!-- To find out the registered gov't departments in the citizen's district-->
              <?php
              ...
              <?php if($result2) { ?>
                ...
                <?php if($num_rows2>0) { ?>
                  <?php while($govt = mysqli_fetch_assoc($result2)) : ?>
                    <option value="<?php echo $govt['dep_name']; ?>"><?php echo $govt['dep_name'];?></option>
                  <?php endwhile; ?>
                <?php } ?>
              <?php } ?>
            </select>
...
<footer class="container-fluid">
  <p>Developed by MakeADifference Team</p>
</footer>
